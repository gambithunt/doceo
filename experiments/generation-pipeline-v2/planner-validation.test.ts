...
function validPlan(): QuestionPlan {
	return {
		...
		visualStates: [
			{ id: 'new', label: 'New Moon', relationshipToPrevious: 'start' },
			{ id: 'quarter', label: 'First quarter', relationshipToPrevious: 'earlier_to_later' }
		],
		likelyMisconceptions: ['Earth’s shadow normally causes the phases.'],
		...
		sources: [
			{
				...
				claims: ['Half of the Moon is illuminated by the Sun.']
			},
			{
				id: 'source-2',
				title: 'Lunar phases',
				...
				claims: ['The visible illuminated fraction changes during the orbit.']
			}
		]
	};
}
