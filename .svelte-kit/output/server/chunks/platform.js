import { o as onboardingCountries, b as getCurriculumsByCountry, c as getGradesByCurriculum, d as getSubjectsByCurriculumAndGrade, g as getRecommendedSubject, e as defaultTerm, f as defaultSchoolYear, h as onboardingStepOrder, a as getSelectionMode } from "./onboarding.js";
const questions = [
  {
    id: "q-fractions-1",
...
function createInitialState() {
  ...
  return {
    ...
    onboarding: {
      ...
      selectedSubjectNames: availableSubjects.filter((subject) => selectedStructuredSubjectIds.includes(subject.id)).map((subject) => subject.name),
      customSubjects: [],
      customSubjectInput: "",
